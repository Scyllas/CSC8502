...
SceneA::SceneA(Window & parent) : OGLRenderer(parent)
{
...
void SceneA::GenerateScreenTexture(GLuint & into, bool depth) {
...
void SceneA::UpdateScene(float msec) {
...
void SceneA::DrawText(const std::string &text, const Vector3 &position, const float size, const bool perspective) {
